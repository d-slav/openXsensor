...
#define RESISTOR_TO_GROUND 2.2
#define RESISTOR_TO_VOLTAGE 56.0
#define OFFSET_VOLTAGE 63.5399582796
#define SCALE_VOLTAGE 1.0075178541

#define PIN_CURRENTSENSOR 2
#define MVOLT_AT_ZERO_AMP 25.0
#define MVOLT_PER_AMP     24.8
